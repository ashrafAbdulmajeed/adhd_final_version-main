...
class UpdateChildInfoScreen extends StatefulWidget {
  ...
  const UpdateChildInfoScreen({Key? key, required this.model})
      : super(key: key);
...
class _UpdateChildInfoScreenState extends State<UpdateChildInfoScreen> {
  ...
  @override
  void initState() {
    _setValue(widget.model.gender == 'girl' ? 1 : 0);
    AppCubit.get(context).switchAge(widget.model.age);
    childNameController.text = widget.model.name!;
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit, AppStates>(listener: (context, state) {
      if (state is ChildUpdatedErrState) {
        ScaffoldMessenger.of(context)
            .showSnackBar(SnackBar(content: Text(state.error)));
      }

      if (state is ChildUpdatedSuccessState) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text("Your child updated Successfully!".tr(context))));
      ...
      return Scaffold(
        appBar: AppBar(
          ...
          bottom: PreferredSize(
            ...
            child: state is ChildUpdatedLoadingState
              ...
              child: Theme(
                  ...
                  child: Stepper(
                    ...
                    onStepContinue: () {
                      ...
                      if (isLastStep) {
                        AppCubit.get(context).updateChildInfo(
