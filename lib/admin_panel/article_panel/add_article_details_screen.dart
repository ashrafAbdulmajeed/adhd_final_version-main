...
class AddArticleDetailsScreen extends StatefulWidget {
  const AddArticleDetailsScreen({Key? key, required this.mainArticleModel})
      : super(key: key);
  final MainArticleModel mainArticleModel;
  @override
  _AddArticleDetailsScreenState createState() =>
      _AddArticleDetailsScreenState();
}

class _AddArticleDetailsScreenState extends State<AddArticleDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Article Details'),
        centerTitle: true,
      ),
      body: Padding(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomAdminButton(
                  title: "Add Tips ${_tipsList.length}",
                  onPressed: () {
                    // tipModel= TipModel();
                    AwesomeDialog(
