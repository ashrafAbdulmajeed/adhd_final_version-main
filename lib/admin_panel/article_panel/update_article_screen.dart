...
import 'package:adhd_app/admin_panel/article_panel/update_article_detail_screen.dart';
...
class UpdateArticleScreen extends StatefulWidget {
  const UpdateArticleScreen({Key? key, required this.mainArticleModel})
      : super(key: key);
...
class _UpdateArticleScreenState extends State<UpdateArticleScreen> {
  ...
  @override
  void initState() {
    _titleController.text = widget.mainArticleModel.title.toString();
    _titleArController.text = widget.mainArticleModel.titleAr.toString();
    ...
    _imageUrl = widget.mainArticleModel.imageUrl.toString();
    _articleIdController.text = widget.mainArticleModel.imageUrl.toString();
    super.initState();
  }
                        ...
                        : CustomAdminButton(
                            ...
                            onPressed: () async {
                              if (_formKey.currentState!.validate()) {
                                ...
                                var newArticle =
                                    widget.mainArticleModel.copyWith(
                                ...
                                await _uploadImage(newArticle.articleId!)
                                  ...
                                  await collectionRef
                                      .update(newArticleWithImage.toJson())
                                      .then(
                                    (value) {
